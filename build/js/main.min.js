...
var text = document.querySelector('.about-us__text');
button.onclick = function () {
  text.classList.toggle('is-active');
  button.innerHTML = button.innerHTML === 'Подробнее' ? button.innerHTML = 'Свернуть' : button.innerHTML = 'Подробнее';
};
var contacts = document.querySelector('.footer-contacts');
var contactsBtn = document.querySelector('.footer-contacts__title');
var siteList = document.querySelector('.site-list');
var siteListBtn = document.querySelector('.site-list__title');
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      var nameInput = document.getElementById('name-callme');
